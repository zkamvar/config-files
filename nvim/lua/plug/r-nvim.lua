...
opts.hook = {
  on_filetype = function()
    ...
    vim.api.nvim_buf_set_keymap(0, "n", "<c-L>", "<Cmd>lua require('r.send').cmd('devtools::load_all()')<CR>", {})
    vim.api.nvim_buf_set_keymap(0, "n", "<c-D>", "<Cmd>lua require('r.send').cmd('devtools::document()')<CR>", {})
    vim.api.nvim_buf_set_keymap(0, "n", "<c-T>", "<Cmd>lua require('r.send').cmd('devtools::test()')<CR>", {})
    vim.api.nvim_buf_set_keymap(0, "n", "<c-E>", "<Cmd>lua require('r.send').cmd('devtools::check()')<CR>", {})
    vim.api.nvim_buf_set_keymap(0, "n", "<tab>", "<Cmd>lua require('r.send').cmd('devtools::test_active_file("..'"'..fname..'"'..")')<CR>", {})
  end,
}
